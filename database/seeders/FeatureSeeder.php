...
class FeatureSeeder extends Seeder
{
    public function run(): void
    {
        $features = [
            ...
            ['key' => 'cashier_management', 'label_bn' => 'ক্যাশিয়ার যোগ করার সুবিধা', 'label_en' => 'Add a cashier', 'category' => 'staff', 'description' => 'Let the shop owner add one cashier account with limited, owner-chosen access.'],
