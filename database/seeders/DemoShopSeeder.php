...
class DemoShopSeeder extends Seeder
{
    ...
    private function groceryFlagship(): void
    {
        ...
        $shop = ShopProvisioner::provision(
            ...
            featureKeys: Feature::pluck('key')->all(),
        );
        ...
        $boxUnit = Unit::create(['shop_id' => $shop->id, 'name' => 'বক্স', 'name_en' => 'Box', 'code' => 'box']);
        ...
        $centerFruit = Product::create([
            'shop_id' => $shop->id,
            'category_id' => $cat['Snacks']->id ?? null,
            'unit_id' => $piecesUnit?->id,
            'name' => 'সেন্টার ফ্রুট বক্স (১০০ পিস)',
        ...
        $customers = [
            Customer::create(['shop_id' => $shop->id, 'name' => 'করিম মিয়া', 'phone' => '01812-111222', 'due' => 1250, 'total_spent' => 18400, 'visits' => 23]),
            Customer::create(['shop_id' => $shop->id, 'name' => 'সালমা বেগম', 'phone' => '01911-333444', 'due' => 640, 'total_spent' => 9200, 'visits' => 14]),
            Customer::create(['shop_id' => $shop->id, 'name' => 'আব্দুল্লাহ', 'phone' => '01677-555666', 'due' => 2100, 'total_spent' => 31500, 'visits' => 41]),
            Customer::create(['shop_id' => $shop->id, 'name' => 'নাসরিন আক্তার', 'phone' => '01555-777888', 'due' => 0, 'total_spent' => 5600, 'visits' => 8]),
            Customer::create(['shop_id' => $shop->id, 'name' => 'কাসিম উদ্দিন', 'phone' => '01722-999000', 'due' => 380, 'total_spent' => 12750, 'visits' => 19]),
        ];
        ...
        $shop->update(['invoice_counter' => 1042]);

        $expCat = ExpenseCategory::create(['shop_id' => $shop->id, 'name' => 'দোকান ভাড়া', 'name_en' => 'Shop rent', 'emoji' => '🏠']);
        $expCat2 = ExpenseCategory::create(['shop_id' => $shop->id, 'name' => 'বিদ্যুৎ বিল', 'name_en' => 'Electricity', 'emoji' => '💡']);
        Expense::create(['shop_id' => $shop->id, 'expense_category_id' => $expCat->id, 'memo' => 'জুলাই ভাড়া', 'amount' => 8000, 'method' => 'cash', 'date' => now()->subDay()->toDateString()]);
        Expense::create(['shop_id' => $shop->id, 'expense_category_id' => $expCat2->id, 'memo' => 'বিদ্যুৎ', 'amount' => 1200, 'method' => 'cash', 'date' => now()->toDateString()]);

        Purchase::create(['shop_id' => $shop->id, 'supplier' => 'তীর ডিস্ট্রিবিউটর', 'memo' => 'তেল+চিনি স্টক', 'amount' => 12600, 'method' => 'credit', 'date' => now()->subDays(2)->toDateString()]);

        Damage::create(['shop_id' => $shop->id, 'product_id' => $productModels[3]->id, 'qty' => 2, 'reason' => 'মেয়াদ শেষ', 'loss' => 48, 'date' => now()->subDay()->toDateString()]);
    ...
    private function lightDemo(string $typeSlug, string $shopName, string $phone, string $area): void
    {
        ...
        if ($typeSlug === 'pharmacy') {
            ...
            $medicine = Product::create([
                ...
                'name' => 'নাপা ট্যাবলেট (১০০ পিস বক্স)',
